...
CATEGORY RULES:
- Always use "Deep Dive" as the category. All articles are deep dives covering company-specific analysis, thematic analyses, market notes, and sector-level insights.`;
